...
import data_helpers
from text_cnn_gen import TextCNN
...
tf.flags.DEFINE_integer("num_tune_epochs", 100, "Number of training epochs")
    ...
    with sess.as_default():
        ...
        optimizer_d = tf.train.AdamOptimizer(
            learning_rate = learning_rate
                ...
                adv_lambda * cnn.domain_loss + adv_lambda * cnn.gen_loss,
                var_list=var_d
            )
        ...
        optimizer_g = tf.train.AdamOptimizer(
            learning_rate=learning_rate
                ...
                cnn.y_loss + adv_lambda * cnn.gen_loss - adv_lambda * cnn.domain_loss,
                var_list=var_g,
                global_step = global_step
                )
