...
class TextCNN(object):
    ...
    def __init__(self, sequence_length, num_classes, vocab_size,
        ...
        self.pri_h_pool = tf.matmul(
            tf.cast( tf.expand_dims(self.input_d, axis=1), "float32"),
            all_pri_h_pool
        )
        self.pri_h_pool = tf.reshape(self.pri_h_pool, shape = [-1, num_filters_total])
        ...
        with tf.variable_scope("label"):
            ...
            self.y_scores_softmax = tf.nn.softmax(self.y_scores)
